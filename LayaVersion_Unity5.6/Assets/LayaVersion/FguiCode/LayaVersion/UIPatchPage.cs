...
{
	public partial class UIPatchPage : GComponent
	{
		public GGraph m_n21;
		...
		public const string URL = "ui://4yrap86wjw3e13";

		public static UIPatchPage CreateInstance()
		{
			return (UIPatchPage)UIPackage.CreateObject("LayaVersion","PatchPage");
		}
